...
import { getBidsForProduct, getHighestBid, placeOrder, createDelivery, getAllProducts } from '../api';
    ...
    <>
      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <Dialog open={confirmOpen} onClose={() => setConfirmOpen(false)}>
          ...
          <DialogContent>
            <Typography>
              Are you sure you want to proceed? ${selectedProduct && highestBids[selectedProduct.id]?.bidAmount.toFixed(2)} will be deducted from your wallet.
            </Typography>
          </DialogContent>
          <DialogActions>
            <Button onClick={() => setConfirmOpen(false)}>Cancel</Button>
            <Button onClick={confirmOrder} variant="contained" color="primary" autoFocus>
              Confirm & Pay
            </Button>
          </DialogActions>
        </Dialog>
