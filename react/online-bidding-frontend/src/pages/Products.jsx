            ...
            <DialogContent>
              <Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                  ...
                  {photo && <Typography variant="caption" display="block" sx={{ mt: 1 }}>Selected: {photo.name}</Typography>}
                  {photoError && <Typography color="error" variant="caption" display="block">{photoError}</Typography>}
                </Grid>
              </Grid>
            </DialogContent>
            <DialogActions>
